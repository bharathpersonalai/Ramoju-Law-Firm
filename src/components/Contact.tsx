    ...
    <section id="contact" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            Ready to discuss your legal needs? Contact us today to schedule your free consultation.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="text-lg font-semibold text-navy-900 mb-1" style={{ fontFamily: 'Merriweather, serif' }}>Phone</h4>
                <a href="tel:919553410353" className="text-gray-600 hover:text-gold transition-colors duration-200" style={{ fontFamily: 'Inter, sans-serif' }}>
                  +91 9553410353 
                </a>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="text-lg font-semibold text-navy-900 mb-1" style={{ fontFamily: 'Merriweather, serif' }}>Email</h4>
                <a href="mailto:ramojulawfirm@gmail.com" className="text-gray-600 hover:text-gold transition-colors duration-200" style={{ fontFamily: 'Inter, sans-serif' }}>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="text-lg font-semibold text-navy-900 mb-1" style={{ fontFamily: 'Merriweather, serif' }}>Office Address</h4>
                <p className="text-gray-600" style={{ fontFamily: 'Inter, sans-serif' }}>
                  Ramoju Law Firm, Opp. Union Bank, 'X' Road,Gajularamaram<br /> 
...
></iframe>
          </div> {/* <-- THIS IS THE MISSING CLOSING DIV that closes Column 1 */}
  ...
  <div className="bg-white rounded-xl shadow-xl p-8">
    ...
    <div className="space-y-4">
      <div 
        ...
        style={{ fontFamily: 'Inter, sans-serif' }}
      >
        <span className="text-lg text-gray-600">Monday - Saturday</span>
    ...
    <p className="text-sm text-gray-500 mt-6 italic" style={{ fontFamily: 'Inter, sans-serif' }}>
      Our attorneys are available for consultations during these times. Please call ahead to schedule.
    </p>
  </div>
