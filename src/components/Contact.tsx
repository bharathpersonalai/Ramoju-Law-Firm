        ...
        <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-[#1a2f42] text-white rounded-2xl p-6 flex items-center space-x-6 transition-transform hover:scale-105 duration-300">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="block text-lg opacity-90 hover:opacity-100 transition-opacity"
                    >
                      +91 95534 10353
                    </a>
                    <a
                      href="tel:+919948272818"
                      className="block text-lg opacity-90 hover:opacity-100 transition-opacity"
                    >
                      +91 99482 72818
                    </a>
                ...
                <div className="bg-[#1a2f42] text-white rounded-2xl p-6 flex items-center space-x-6 transition-transform hover:scale-105 duration-300">
                  ...
                  <div>
                    ...
                    <a
                      href="https://maps.app.goo.gl/iFSe6ztiibSVwbqq6"
                      target="_blank"
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-xl p-8">
              ...
              {/* --- THIS LINE IS UPDATED FOR RESPONSIVE ALIGNMENT --- */}
              <div
                className="flex flex-col items-start gap-2 py-4 border-t border-gray-200 sm:flex-row sm:items-center sm:justify-between"
                style={{ fontFamily: "Inter, sans-serif" }}
              >
              ...
              <p
                ...
                style={{ fontFamily: "Inter, sans-serif" }}
              >
                We are available 24/7 for scheduled consultations. Please
